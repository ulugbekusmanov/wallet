...
class ETHTransferScreen extends StatelessWidget {
  ...
  int accountFrom;
  ETHTransferScreen(this.balance, this.accountFrom, {Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BaseView<ETHTransferModel>(
      onModelReady: (model) async {
        ...
        model.ethBalance = model.account.coinBalances.firstWhere((b) => b.token.symbol == 'ETH');
        model.init();
      },
                                    ...
                                    GestureDetector(
                                      ...
                                      onTap: () async {
                                        var addressBookPick = await Navigator.of(context).push<String?>(
                                          PageTransition(
                                            child: AddressBookPickerScreen(TokenNetwork.Ethereum),
